...
//
// Included for the surface hook and u_halfExtent; the patch and morph machinery
// it also declares belongs to the vertex stages and goes unused here.
...
void main() {
   ...
   vec3 spherePosition = normalize(vert_spherePosition) * u_halfExtent;
